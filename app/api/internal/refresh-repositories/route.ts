...
const refreshRequestSchema = z.object({
  enqueueLimit: z.number().int().nonnegative().optional(),
  generatorEnqueueLimit: z.number().int().nonnegative().optional(),
  retryCooldownHours: z.number().int().nonnegative().optional(),
