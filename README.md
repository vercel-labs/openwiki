...
Generate a living, source-grounded wiki for any GitHub repository. Built on [eve](https://eve.dev).

OpenWiki is a Next.js app backed by an embedded [eve](https://eve.dev) agent. Give it a repository, and it plans a docs-style outline, writes source-cited pages, publishes a navigable wiki, and keeps published repositories fresh as the source changes.
